...
class TCPFrontEnd {
	 ...
	 * It creates the pages "my address", "my downloads" and "my downloads"
	 */
	...
	/**
	 * Creates "My addresses" page.
	 *
	 * This page allows to admin users' addresses from the front end, not using the back end
	 */
	...
	/**
	 * Creates "My downloads" page.
	 *
	 * This page allows to access to my downloads using the front end, not the back end
	 */
	...
	/**
	 * Creates "My orders" page.
	 *
	 * This page allows to access to users' orders from the front end, not using the back end
	 */
	...
	/**
	 * Checks if the plugin is installed right.
	 *
	 * It looks for the pages created by this plugin. If administrator wants to hide any of them,
	 * they must set them in draft mode
	 */
...
// Template functions added by TheCartPress Front end plugin

/**
 * Returns My Orders page URL
 */
